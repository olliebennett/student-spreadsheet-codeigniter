...
--
-- Host: localhost
-- Generation Time: Jun 30, 2013 at 09:22 AM
...
DROP TABLE IF EXISTS `link_houses_users`;
...
DROP TABLE IF EXISTS `link_notifications_users`;
...
DROP TABLE IF EXISTS `link_purchases_users`;
...
DROP TABLE IF EXISTS `stsp_sessions`;
